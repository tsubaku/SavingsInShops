...
public class ProductActivity extends ActionBarActivity {
    ...
    static final private int NUMBER_SUB_PRODUCT_ACTIVITY = 3;   //Номер активити выбора продуктов
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // selectionMarket.setText(listMarket);    //Показываем список выбранных магазинов
        ...
        if (listChangeMarket.isEmpty()){
            ...
            {
                selectionMarket.append("  " + listChangeMarket.get(i) + "  ");//Показываем список выбранных магазинов
            }
        }
        //Забираем из МайнАктивити список выбранных продуктов (если он там был)
        ...
        //        selectionProduct.setText(""); //Обнуление метки списка выбранных продуктов
            ...
            //    }
                ...
                intentSubProduct.putExtra("typeProduct", typeProduct);  //Сохраняем тип продуктов, которые будем выбирать
                intentSubProduct.putExtra("generalMapProduct", generalMapProduct);//сохраняем общий список выбранных продуктов
               // intentSubProduct.putExtra("putChangeMarketList", listChangeMarket); //Сохраняем список выбранных магазинов
    ...
    public void onClickNext2(View view) {
        ...
        intentTableActivity.putExtra("putChangeMarketList", listChangeMarket);//Сохраняем списки
    ...
    public void onClickBack2(View view) {
        ...
        ProductIntent.putExtra("generalMapProduct", generalMapProduct);//сохраняем общий список выбранных продуктов
